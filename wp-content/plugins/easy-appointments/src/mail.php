...
class EAMail
{
    ...
    public function init()
    {
        ...
        add_action('ea_admin_email_notification', array($this, 'send_admin_email_notification_action'), 10, 1);
     ...
     * @param  int $app_id Application id
     */
    public function send_admin_email_notification_action($app_id)
    {
        $this->send_notification(array('id' => $app_id));
    }
     ...
     */
    public function send_notification($input_data)
    {
        $emails = array();
    ...
    public function send_status_change_mail($app_id)
    {
        ...
        if (array_key_exists('email', $app_array)) {
            ...
            $this->send_email($app_array['email'], $subject, $body, $headers);
        }
    }
     ...
     * @param array $headers
     */
    protected function send_email($email, $subject, $body, $headers)
    {
